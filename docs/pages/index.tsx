      ...
      <div className="ui container">
        <h1 className="ui header">
          <div className="content">
            fabricjs-psbrush
            <div className="sub header">A lightweight pressure-sensitive brush implementation for Fabric.js</div>
          </div>
        </h1>
      </div>
    </div>
    <div className="main content">
      <div className="ui container">
        <div className="ui message">
          ...
          <p>For more details on how to use this library, please refer to the following documents.</p>
        </div>
        <div className="ui selection divided list">
          <a className="item" href="https://www.npmjs.com/package/@arch-inc/fabricjs-psbrush">
          ...
          <a className="item" href="https://github.com/arch-inc/fabricjs-psbrush">
          ...
          <a className="item" href="https://arch-inc.github.io/fabricjs-psbrush/api/globals.html">
            <i className="file alternate outline icon"></i>
            <div className="content">
              <div className="header">API document</div>
              <div className="description">automatically generated with TypeDoc</div>
            </div>
          </a>
          <a className="item" href="https://arch-inc.github.io/fabricjs-psbrush/index.js">
            <i className="file code outline icon"></i>
            <div className="content">
              <div className="header">index.js</div>
              <div className="description">example code loaded in this page</div>
            </div>
          </a>
        </div>
      </div>
      <div className="canvas-wrapper">
        <div className="ui container">
          ...
          <p>Draw anything on the white blank canvas shown below; tested on iPad Pro and Surface Go.</p>
